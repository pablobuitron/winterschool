      ...
      <nav className="bg-white shadow-lg sticky top-0 z-50">
        <div className="max-w-none mx-auto px-4 sm:px-5 lg:px-6">
          <div className="flex justify-between items-center h-16">
            <h1 className="text-xl font-bold text-[#17172F] whitespace-nowrap"><a href="https://cldws2027.uninettunouniversity.net/#home" rel="noreferrer" >Winter School 2027</a></h1>
                ...
                {navItems.map((item) => (
                  <button
                    ...
                    className={`px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeSection === item.toLowerCase().replace(/ /g, '-')
                        ? 'bg-[#666666] text-[#17172F]'
                        : 'text-[#17172F] hover:bg-gray-100 hover:text-[#F53A4B]'
                      }`}
                  >
                    {item}
                  </button>
